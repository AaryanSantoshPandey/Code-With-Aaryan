                ...
                <div class="mx-auto w-full xl:text-lg font-medium pt-3 px-2 rounded-t-lg lg:w-1/3 overflow-x-hidden">
                    ...
                    <div
                        ...
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <a href="../../course/web developer wallah/index.php"><div class="mt-4 cursor-pointer">Introduction to HTML, CSS, JavaScript & How websites work? | Web Development Tutorials #1</div></a>
                        </div>
                        <a href="../../course/web developer wallah/video1.php"><div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
