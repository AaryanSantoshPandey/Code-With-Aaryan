    ...
    <div id="__next">
                ...
                <div class="mx-auto w-full xl:text-lg font-medium pt-3 px-2 rounded-t-lg lg:w-1/3 overflow-x-hidden">
                    ...
                    <div
                        ...
                        <div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
                            <a href="../../courses/web developer wallah/index.php"><div class="mt-4 cursor-pointer">Introduction to HTML, CSS, JavaScript & How websites work? | Web Development Tutorials #1</div></a>
                        </div>
                        <a href="../../courses/web developer wallah/video1.php"><div class="px-2 mt-4 flex lg:px-8 py-2 bg-white rounded-lg shadow-lg"><input type="checkbox"
                                name="" id="" class="mr-2" />
        ...
        <div id="panels">
            ...
            <div class="flex mx-4 lg:mr-16 my-3 px-3 justify-between lg:w-2/3"><a href=""></a><button
                    ...
                    disabled=""> Previous </button></a><a href="../../courses/web developer wallah/video1.php"><button
                        class="text-white w-20 cursor-pointer justify-center bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center mx-1 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-default">
                        Next </button></a></div>
        </div>
